...
class MateExceptSettingScreen extends StatefulWidget {
  final SettingRepository settings;
  final String? source;
  const MateExceptSettingScreen({
    super.key,
  ...
  @override
  State<MateExceptSettingScreen> createState() => _MateExceptSettingScreenState();
}

class _MateExceptSettingScreenState extends State<MateExceptSettingScreen> {
