...
class PersonalInfoSettingScreen extends StatefulWidget {
  final SettingRepository settings;
  final String? source;
  const PersonalInfoSettingScreen({
    super.key,
  ...
  @override
  State<PersonalInfoSettingScreen> createState() => _PersonalInfoSettingScreenState();
}

class _PersonalInfoSettingScreenState extends State<PersonalInfoSettingScreen> {
  ...
  void initState() {
    ...
    _apiKeyController.text =
        widget.settings.stringDefault(settingOpenAIAPIToken, '');
    _organizationController.text =
        widget.settings.stringDefault(settingOpenAIOrganization, '');
    _urlController.text = widget.settings.stringDefault(settingOpenAIURL, '');
    if (widget.source == 'setting') {
      enableOpenAISelfHosted =
  ...
  void onSaveAndEnter(String apiKey, String organization, String url,
